...
function addItem() {
   ...
   for (let i = 0 ; i < ToDoList.length ; i++){
      ...
      const phra2 = `<div class="todo-item"><p class="task-text">${task}</p><p class="date-text">${duedate}</p><button class="button2" onclick="ToDoList.splice(${i},1);rendertodolist()">delete <i class="fa-solid fa-box-archive"></i></button></div>`
      todolisthtml += phra2
